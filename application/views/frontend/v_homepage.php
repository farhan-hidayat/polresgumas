    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-6 col-md-3 col-lg-2" data-aos="fade-up" data-aos-delay="100">
          <a href="#" class="component-categories d-block">
            <div class="categories-image">
              <img src="<?php echo base_url(); ?>assets/images/categories-gadgets.svg" alt="" class="w-100" />
        ...
        <div class="col-6 col-md-3 col-lg-2" data-aos="fade-up" data-aos-delay="200">
          <a href="#" class="component-categories d-block">
            <div class="categories-image">
              <img src="<?php echo base_url(); ?>assets/images/categories-furniture.svg" alt="" class="w-100" />
        ...
        <div class="col-6 col-md-3 col-lg-2" data-aos="fade-up" data-aos-delay="300">
          <a href="#" class="component-categories d-block">
            <div class="categories-image">
              <img src="<?php echo base_url(); ?>assets/images/categories-makeup.svg" alt="" class="w-100" />
        ...
        <div class="col-6 col-md-3 col-lg-2" data-aos="fade-up" data-aos-delay="400">
          <a href="#" class="component-categories d-block">
            <div class="categories-image">
              <img src="<?php echo base_url(); ?>assets/images/categories-sneaker.svg" alt="" class="w-100" />
        ...
        <div class="col-6 col-md-3 col-lg-2" data-aos="fade-up" data-aos-delay="500">
          <a href="#" class="component-categories d-block">
            <div class="categories-image">
              <img src="<?php echo base_url(); ?>assets/images/categories-tools.svg" alt="" class="w-100" />
        ...
        <div class="col-6 col-md-3 col-lg-2" data-aos="fade-up" data-aos-delay="600">
          <a href="#" class="component-categories d-block">
            <div class="categories-image">
              <img src="<?php echo base_url(); ?>assets/images/categories-baby.svg" alt="" class="w-100" />
