								...
								<tbody>
									...
									foreach($gallery as $a){ 
										...
										<tr>
											...
											<td><img width="100%" class="img-responsive" src="<?php echo base_url().'/gambar/gallery/'.$a->sampul; ?>"></td>
											<td>
												<?php 
												if($a->status=="publish"){
											...
											// cek apakah penggun yang login adalah penulis
												...
												// jika penulis, maka cek apakah penulis artikel ini adalah si pengguna atau bukan
													if($this->session->userdata('id') == $a->author){
														?>
														<a href="<?php echo base_url().'dashboard/gallery_edit/'.$a->gallery_id; ?>" class="btn btn-warning btn-sm"> <i class="fa fa-pen"></i> </a>
														<a href="<?php echo base_url().'dashboard/gallery_hapus/'.$a->gallery_id; ?>" class="btn btn-danger btn-sm"> <i class="fa fa-trash"></i> </a>
														<?php
													}
												}else{
