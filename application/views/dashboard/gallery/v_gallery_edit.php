						...
						<div class="card-body">
							...
							<div class="card-body">
								<div class="form-group">
									<label>Judul</label>
									<input type="hidden" name="id" value="<?php echo $a->gallery_id; ?>">
									<input type="text" name="judul" class="form-control" placeholder="Masukkan judul.." value="<?php echo $a->judul; ?>">
									<br/>
							...
							<div class="form-group">
								...
								<select class="form-control" name="kategori">
									...
									<?php foreach($kategori as $k){ ?>
										<option <?php if($a->kategori == $k->kategori_id){echo "selected='selected'";} ?> value="<?php echo $k->kategori_id ?>"><?php echo $k->kategori_nama; ?></option>
									<?php } ?>
								</select>
								<br/>
