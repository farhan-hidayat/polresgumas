							...
							<div class="card-body">
								...
								<div class="card-body">
									<div class="form-group">
										...
										<input type="text" name="judul" class="form-control" placeholder="Masukkan judul artikel.." value="<?php echo $a->judul_artikel; ?>">
										<br />
								...
								<div class="card-body">
									<div class="form-group">
										...
										<br />
										<textarea class="form-control" id="summernote" name="konten"> <?php echo $a->konten_artikel; ?> </textarea>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<select class="form-control" name="kategori">
										...
										<?php foreach ($kategori as $k) { ?>
											<option <?php if ($a->kategori_artikel == $k->id) {
